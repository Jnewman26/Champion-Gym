<template>
    ...
    <DashboardLayout>
            ...
            <form @submit.prevent="update">
                <div class="grid gap-4 mb-4 sm:grid-cols-1">
                    <div>
                        ...
                        <input type="text" class="input" v-model="form.personal_trainer_session">
                    ...
                    <div>
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Personal
                            trainer contact</label>
                        <input type="number" class="input" v-model="form.personal_trainer_duration">
                    ...
                    <div>
                        ...
                        <div class="flex">
                            ...
                            <input type="number"
                                ...
                                v-model="form.personal_trainer_price">
                        </div>
                ...
                <div class="flex justify-between">
                    <button type="button" class="btn-danger flex"
                        v-bind:data-modal-toggle="'#deleteperonaltrainer-' + form.personal_trainer_id">
                        Delete
                    </button>
        ...
        <div v-bind:id="'#deleteperonaltrainer-' + personalTrainers.personal_trainer_id" tabindex="-1"
            ...
            <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <button type="button"
                        ...
                        v-bind:data-modal-hide="'#deleteperonaltrainer-' + personalTrainers.personal_trainer_id">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                            Are you sure you want to delete this personal trainer?
                        </h3>
                        <button data-modal-hide="deleteAdmin" type="button"
                            class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2"
                            @click="deleteperonaltrainer">
                            Yes, I'm sure
                        </button>
                        <button v-bind:data-modal-hide="'#deleteperonaltrainer-' + personalTrainers.personal_trainer_id"
                            type="button"
...
export default {
    props: {
        personalTrainers: Object,
        errors: Object
    },
    data() {
        return {
            form: {
                personal_trainer_id: this.personalTrainers.personal_trainer_id,
                personal_trainer_session: this.personalTrainers.personal_trainer_session,
                personal_trainer_duration: this.personalTrainers.personal_trainer_duration,
                personal_trainer_price: this.personalTrainers.personal_trainer_price,
            }
        }
    },
    methods: {
        update() {
            this.$inertia.put('/personal-trainer-edit/' + this.personalTrainers.personal_trainer_id, this.form)
        },
        deleteperonaltrainer() {
            this.$inertia.delete(`/personal-trainer-delete/${this.personalTrainers.personal_trainer_id}`)
        },
    }
}
</script>