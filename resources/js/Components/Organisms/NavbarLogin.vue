<template>
    <nav class="fixed top-0 bg-white border-gray-200 dark:bg-gray-900 w-full shadow z-40">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex ml-2">
                <img src="@/Assets/Images/Logo/logo-title.png" class="h-6 mr-3" alt="Champion Logo" />
            </a>
            <div class="flex items-center md:order-2">

                <button id="dropdownNotificationButton" data-dropdown-toggle="dropdownNotification"
                    class="inline-flex items-center text-sm font-medium text-center text-gray-500 hover:text-gray-900 focus:outline-none me-2"
                    type="button">
                    <i class="fas fa-bell text-slate-500 text-lg"></i>
                    <div class="relative flex">
                        <div
                            class="relative inline-flex w-3 h-3 bg-red-500 border-2 border-white rounded-full -top-2 right-2">
                        </div>
                    </div>
                </button>
                <!-- Dropdown menu -->
                <div id="dropdownNotification"
                    class="z-20 hidden w-10/12 h-96 max-w-sm overflow-y-scroll bg-white divide-y divide-gray-100 rounded-lg shadow"
                    ...
                    <div class="divide-y divide-gray-100 dark:divide-gray-700">
                        <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                            <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11 p-2 border-2" src="@/Assets/Images/Logo/logo.png">
                            </div>
                ...
                <button id="dropdownAvatarNameButton" data-dropdown-toggle="dropdownAvatarName"
                    class="flex items-center text-sm font-medium text-gray-900 rounded-full hover:text-blue-600 dark:hover:text-blue-500 md:mr-0 focus:ring-4 focus:ring-gray-100"
                    type="button">
                    <span class="sr-only">Open user menu</span>
                    <img class="w-8 h-8 mr-2 bg-rose-500 rounded-full" src="@/Assets/Images/Illustration/profile-1.png"
                        alt="user photo">
                    Bonnie
                ...
                <div id="dropdownAvatarName"
                    ...
                    <div class="px-4 py-3 text-sm text-gray-900 dark:text-white">
                        <div class="font-medium ">Basic member</div>
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                        ...
                        <li>
                            <a href="/member"
                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Member card</a>
                        </li>
                        <li>
                            <a href="/member"
                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Membership</a>
                        </li>
                    </ul>
                    <div class="py-2">
                        <a href="#"
