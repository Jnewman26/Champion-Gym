<template>
    ...
    <DashboardLayout>
        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-5">
                <div class="mb-5">
                    <div class="mb-5">
                        <button data-modal-toggle="createPromotion" class="btn-primary" type="button">
                            <i class="fas fa-plus"></i> Promotion
                        </button>
                    </div>
                </div>
                <DataTable class="display">
                    ...
                    <tbody>
                        <tr v-for="promotion in promotions">
                            ...
                            <td>Rp {{ promotion.promotion_discount }}</td>
                            <td>{{ promotion.promotion_code }}</td>
                            <td>
                                <a :href="`/promotion-edit/${promotion.promotion_id}/edit`" class="btn-primary ms-2">
    ...
    <div id="createPromotion" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                    ...
                    <button type="button"
                        ...
                        data-modal-toggle="createPromotion">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-1">
                        <div>
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Promotion
                                name</label>
                            <input type="text" name="name" id="name" class="input" v-model="promotion.promotion_name">
                        ...
                        <div>
                            ...
                            <div class="flex">
                                ...
                                <input type="number"
                                    ...
                                    placeholder="" v-model="promotion.promotion_discount">
                            </div>
                        ...
                        <div>
                            <label for="email"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Promotion code</label>
                            <input type="text" name="duration" id="duration" class="input" placeholder=""
...
export default {
    ...
    methods: {
        submit() {
            this.$inertia.post('/promotion', this.promotion)
        },
        closeBanner() {
            this.$page.props.flash.message = '';
        },
        openModal(promotion_id) {
            this.selectedPromotionsId = promotion_id;
        },
        autoRefresh() {
