<template>
    ...
    <DashboardLayout>
        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-5">
                <div class="mb-5">
                    <div class="mb-5">
                        <button data-modal-toggle="createMembership" class="btn-primary" type="button">
                            <i class="fas fa-plus"></i> Membership
                        </button>
                    </div>
                </div>
                <DataTable class="display">
                    <thead>
                        <tr>
                            ...
                            <th>Membership duration (month)</th>
                            <th>Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr v-for="membership in memberships">
                            ...
                            <td>Rp {{ membership.membership_price }}</td>
                            <td>{{ membership.membership_duration }}</td>
                            <td>
                                <!-- <button class="btn-primary ms-2" type="button" v-bind:data-modal-toggle="'detailMembership-' + membership.membership_id" @click="openModal">
                                    <i class="fa-solid fa-list-ol"></i>
                                </button> -->
                                <a :href="`/membership-edit/${membership.membership_id}/edit`" class="btn-primary ms-2">
                                    <i class="fa-solid fa-list-ol"></i>
                                </a>
                            </td>
                        </tr>
    ...
    <div id="createMembership" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                    ...
                    <button type="button"
                        ...
                        data-modal-toggle="createMembership">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-1">
                        <div>
                            <label for="name"
                                ...
                                name</label>
                            <input type="text" class="input" v-model="membership.membership_name">
                        ...
                        <div>
                            ...
                            <div class="flex">
                                ...
                                <input type="number"
                                    ...
                                    placeholder="" v-model="membership.membership_price">
                            </div>
                        ...
                        <div>
                            ...
                            <input type="number" class="input" v-model="membership.membership_duration">
...
export default {
    ...
    methods: {
        submit() {
            this.$inertia.post('/membership-admin', this.membership)
        },
        closeBanner() {
            this.$page.props.flash.message = '';
        },
        openModal(membership_id) {
            this.selectedMembershipsId = membership_id;
        },
        autoRefresh() {
